...
INP = sys.argv[1] if len(sys.argv) > 1 else os.path.join(HERE, "..", "assets/me", "maulik-raw.png")
OUT = sys.argv[2] if len(sys.argv) > 2 else os.path.join(HERE, "..", "assets/me", "maulik-prepped.png")
